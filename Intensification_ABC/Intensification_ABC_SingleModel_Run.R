...
source("C:/Users/u1132502/Box Sync/ABC_Work/CHPC/Intensification_ABC/04_simulatedmodelspds_singlemodel_run.R")#generates SPDs from the simulated population dynamic
...
delta.val <- cp.delta
    ...
    cp.file <- paste("C:/Users/u1132502/Box Sync/ABC_Work/CHPC/Intensification_ABC/Output/CP/CP_Model_results", Sys.getpid(), ".Rdata", sep="")
...
delta.val <- gb.delta
    ...
    gb.file <- paste("C:/Users/u1132502/Box Sync/ABC_Work/CHPC/Intensification_ABC/Output/GB/GB_Model_results", Sys.getpid(), ".Rdata", sep="")
