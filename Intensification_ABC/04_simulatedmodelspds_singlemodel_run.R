...
createmodelspd <- function(model) {
 ...
 # errors <- sample(dat_cal.Plat.norm$metadata$Error, size = n.samples, replace =TRUE) #generate date errors by sampling 
  ...
  mod.results.df[,13:4013] <- spd.uncalsample.norm$grid$PrDens
  mod.results.df[,4014:8014] <- spd.uncalsample.nnorm$grid$PrDens
  mod.results.df[,8015:12015] <- spd.calsample.norm$grid$PrDens
  mod.results.df[,12016:16016] <- spd.calsample.nnorm$grid$PrDens
